...
class PortfolioHeaderChartViewController: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        return [Wireframe.shared.getCompanyPortfolio(), Wireframe.shared.getProtfolioaIndex(), Wireframe.shared.getProtfolioIssueType(), Wireframe.shared.getPorfolioBuySellView() ]
    }
